function [Out] = likelihood_Lindblad2(f,M,p00,p01,p0p,p0m,p0ip,p0im,p10,p11,p1p,p1m,p1ip,p1im,pp0,pp1,ppp,ppm,ppip,ppim,pm0,pm1,pmp,pmm,pmip,pmim,pip0,pip1,pipp,pipm,pipip,pipim,pim0,pim1,pimp,pimm,pimip,pimim,c)
%Function with the povm likelihood functions
...
%been specified in likelihood_Lindblad1. 
